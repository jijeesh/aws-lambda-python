...
1. Download the [backup-rds.py](https://raw.githubusercontent.com/jijeesh/aws-lambda-python/master/backup-rds.py) file
...
### Related blog posts
- [Copying RDS snapshot to another region for cross-region recovery](https://rightctrl.com/blog/copying-rds-snapshot-to-another-region-for-cross-region-recovery/)
- [Complete code: cross-region RDS recovery](https://rightctrl.com/blog/complete-code-cross-region-rds-recovery/)
- [Cross-region RDS recovery: encryption and Aurora support](https://rightctrl.com/blog/cross-region-rds-recovery-encryption-and-aurora-support/)
...
#### How to use for the first time
1. Download the [ebs-snapshots.py](https://raw.githubusercontent.com/jijeesh/aws-lambda-python/master/ebs-snapshots.py)
...
### Related blog posts
- [Complete code: Automated EC2 snapshots and retention management](https://rightctrl.com/blog/complete-code-automated-ec2-snapshots-and-retention-management/)
